...
func (x *CreatUserRequest) GetMobile() string {
	if x != nil {
		return x.Mobile
	}
	return ""
...
func (x *CreatUserRequest) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *CreatUserResponse) Reset() {
	*x = CreatUserResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreatUserResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreatUserResponse) ProtoMessage() {}

func (x *CreatUserResponse) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_create_user_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreatUserResponse.ProtoReflect.Descriptor instead.
func (*CreatUserResponse) Descriptor() ([]byte, []int) {
	return file_rpc_create_user_proto_rawDescGZIP(), []int{1}
}

func (x *CreatUserResponse) GetUser() *User {
	if x != nil {
		return x.User
	}
	return nil
...
var file_rpc_create_user_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x6d, 0x61, 0x1a, 0x1f, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x74, 0x69, 0x6d,
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0a, 0x75, 0x73,
	0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8a, 0x01, 0x0a, 0x10, 0x43, 0x72, 0x65,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x31, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x55, 0x73,
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1c, 0x0a, 0x04, 0x75, 0x73,
	0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x6d, 0x61, 0x2e, 0x55, 0x73,
	0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x4b, 0x68, 0x61, 0x6e, 0x53, 0x75, 0x66, 0x69, 0x79,
	0x61, 0x6e, 0x4d, 0x69, 0x72, 0x7a, 0x61, 0x2f, 0x6d, 0x69, 0x6e, 0x69, 0x2d, 0x61, 0x73, 0x70,
	0x69, 0x72, 0x65, 0x2d, 0x41, 0x50, 0x49, 0x2f, 0x6d, 0x61, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_rpc_create_user_proto_goTypes = []interface{}{
	...
	(*CreatUserResponse)(nil), // 1: ma.CreatUserResponse
	(*User)(nil),              // 2: ma.User
}
var file_rpc_create_user_proto_depIdxs = []int32{
	2, // 0: ma.CreatUserResponse.user:type_name -> ma.User
...
func file_rpc_create_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_create_user_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreatUserResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
